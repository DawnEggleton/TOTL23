...
accounts.push({
        ...
        type: `Member`,
        bloodStatus: ``,
        charPronouns: ``.toLowerCase(),
        charPronounsClass: ``.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        relationship: ``.toLowerCase(),
        relationshipClass: ``.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        age: parseInt(31),
        ageClass: '30s',
        overview: el.innerText.substring(0, 255) + `... <a href="profile.html#shipper">Read More</a>`,
        alias: `Lux`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        rawAlias: `Lux`,
        pronouns: `She/Her`,
        timezone: `GMT-4:00`,
        contact: `Discord`,
...
accounts.push({
        ...
        charPronouns: `he/him`.toLowerCase(),
        relationship: `Dating`.toLowerCase(),
        charPronounsClass: `he/him`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        relationshipClass: `Dating`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        age: parseInt(36),
        ageClass: '30s',
        overview: el.innerText.substring(0, 255) + `... <a href="profile.html#shipper">Read More</a>`,
        alias: `Lux`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
...
accounts.push({
        ...
        bloodStatus: `halfblood`,
        charPronouns: `he/him`.toLowerCase(),
        relationship: `single`.toLowerCase(),
        charPronounsClass: `he/him`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        relationshipClass: `single`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        age: parseInt(19),
        ageClass: 'Teen',
        overview: el.innerText.substring(0, 255) + `... <a href="profile.html#shipper">Read More</a>`,
        alias: `Lux`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
...
accounts.push({
        ...
        bloodStatus: `halfblood`,
        charPronouns: `he/him`.toLowerCase(),
        relationship: `engaged`.toLowerCase(),
        charPronounsClass: `he/him`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        relationshipClass: `engaged`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        age: parseInt(36),
        ageClass: '30s',
        overview: el.innerText.substring(0, 255) + `... <a href="profile.html#shipper">Read More</a>`,
        alias: `Lux`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
...
accounts.push({
        ...
        charPronouns: `she/her`.toLowerCase(),
        relationship: `It's complicated`.toLowerCase(),
        charPronounsClass: `she/her`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        relationshipClass: `It's complicated`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
        age: parseInt(31),
        ageClass: '30s',
        overview: el.innerText.substring(0, 255) + `... <a href="profile.html#shipper">Read More</a>`,
        alias: `Lux`.toLowerCase().replaceAll(' ', "").replaceAll('\/', "").replaceAll(`'`, ""),
