...
async function FillTracker(username, params = {}) {
    ...
    const config = {
      ...
      trackerwrap: params.thisTracker || $('#clip-active'),
      historywrap: params.thisHistory || $('#clip-history'),
      commwrap: params.thisCommTracker || $('#clip-comm'),
      commhistorywrap: params.thisCommHistoryTracker || $('#clip-comm'),
      auwrap: params.thisauTracker || $('#clip-au'),
      auhistorywrap: params.thisauTracker || $('#clip-au'),
      devwrap: params.thisDevTracker || $('#clip-dev'),
      reqwrap: params.thisReqTracker || $('#clip-req'),
      socialwrap: params.thisSocialTracker || $('#clip-social'),
